...
#define	keytree_define_implements_small(yourtree, nodetype_s, link_member)\
	...
	void			KEYTREE_INIT_(yourtree)(KEYTREE_T_(yourtree) *self, int allow_eq, keytree_comp_node_cb comp_node, keytree_make_node_cb make_node){\
		keytree_init_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), allow_eq, comp_node);\
		(((keytree_t *) self))->make_node = make_node;\
	}\
	\
	void			KEYTREE_SET_EQ_COMP_(yourtree)(KEYTREE_T_(yourtree) *self, keytree_comp_node_cb eq_sort){\
		keytree_set_eq_comp_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), eq_sort);\
	}\
	\
	int				KEYTREE_GET_COUNT_(yourtree)(KEYTREE_T_(yourtree) *self){\
		return keytree_get_count_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self));\
	}\
	\
	nodetype_s*		KEYTREE_REF_HEAD_(yourtree)(KEYTREE_T_(yourtree) *self){\
		return (nodetype_s *)keytree_ref_head_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self));\
	}\
	\
	nodetype_s*		KEYTREE_REF_TAIL_(yourtree)(KEYTREE_T_(yourtree) *self){\
		return (nodetype_s *)keytree_ref_tail_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self));\
	}\
	\
	nodetype_s*		KEYTREE_POP_HEAD_(yourtree)(KEYTREE_T_(yourtree) *self){\
		return (nodetype_s *)keytree_pop_head_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self));\
	}\
	\
	nodetype_s*		KEYTREE_POP_TAIL_(yourtree)(KEYTREE_T_(yourtree) *self){\
		return (nodetype_s *)keytree_pop_tail_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self));\
	}\
	\
	nodetype_s*		KEYTREE_REF_NTH_(yourtree)(KEYTREE_T_(yourtree) *self, int nth){\
		return (nodetype_s *)keytree_ref_nth_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), nth);\
	}\
	\
	int				KEYTREE_ADD_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *node){\
		return keytree_add_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), node);\
	}\
	\
	int				KEYTREE_DEL_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *node){\
		return keytree_del_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), node);\
	}\
	\
	int				KEYTREE_INSERT_BEFORE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node, nodetype_s *node){\
		return keytree_insert_before_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node, node);\
	}\
	\
	int				KEYTREE_INSERT_AFTER_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node, nodetype_s *node){\
		return keytree_insert_after_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node, node);\
	}\
	\
	int				KEYTREE_HAS_NODE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *node){\
		return ((keytree_t *) self) == keytree_link_get_belong_raw(offsetof(nodetype_s, link_member), node);\
	}\
	\
	nodetype_s*		KEYTREE_GET_NEXT_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *node){\
		if((node)->link_member.coll != ((keytree_t *) self)){\
			return NULL;\
		}\
	...
	KEYTREE_T_(yourtree)* KEYTREE_GET_BELONG_(yourtree)(nodetype_s* node){\
		return (KEYTREE_T_(yourtree) *)((node)->link_member.coll);\
	}\
	nodetype_s*		KEYTREE_FIND_EQ_NODE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node){\
		return keytree_find_eq_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_EQ_VALUE_(yourtree)(KEYTREE_T_(yourtree) *self, void *value, size_t value_len){\
		nodetype_s v_node;\
		((keytree_t *) self)->make_node(&v_node, value, value_len);\
		return keytree_find_eq_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), &v_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_EQ_NODE_END_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node){\
		return keytree_find_eq_node_end_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_EQ_VALUE_END_(yourtree)(KEYTREE_T_(yourtree) *self, void *value, size_t value_len){\
		nodetype_s v_node;\
		((keytree_t *) self)->make_node(&v_node, value, value_len);\
		return keytree_find_eq_node_end_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), &v_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_LT_NODE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node){\
		return keytree_find_lt_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_LT_VALUE_(yourtree)(KEYTREE_T_(yourtree) *self, void *value, size_t value_len){\
		nodetype_s v_node;\
		((keytree_t *) self)->make_node(&v_node, value, value_len);\
		return keytree_find_lt_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), &v_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_GT_NODE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node){\
		return keytree_find_gt_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_GT_VALUE_(yourtree)(KEYTREE_T_(yourtree) *self, void *value, size_t value_len){\
		nodetype_s v_node;\
		((keytree_t *) self)->make_node(&v_node, value, value_len);\
		return keytree_find_gt_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), &v_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_LE_NODE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node){\
		return keytree_find_le_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_LE_VALUE_(yourtree)(KEYTREE_T_(yourtree) *self, void *value, size_t value_len){\
		nodetype_s v_node;\
		((keytree_t *) self)->make_node(&v_node, value, value_len);\
		return keytree_find_le_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), &v_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_GE_NODE_(yourtree)(KEYTREE_T_(yourtree) *self, nodetype_s *index_node){\
		return keytree_find_ge_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_FIND_GE_VALUE_(yourtree)(KEYTREE_T_(yourtree) *self, void *value, size_t value_len){\
		nodetype_s v_node;\
		((keytree_t *) self)->make_node(&v_node, value, value_len);\
		return keytree_find_ge_node_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), &v_node);\
	}\
	\
	int				KEYTREE_INIT_ITERATOR_(yourtree)(KEYTREE_T_(yourtree) *self, KEYTREE_ITERATOR_T_(yourtree) *iterator){\
		return keytree_init_iterator_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), ((keytree_iterator_t *) iterator));\
	}\
	\
	int				KEYTREE_INIT_ITERATOR_RANGED_(yourtree)(KEYTREE_T_(yourtree) *self, KEYTREE_ITERATOR_T_(yourtree) *iterator, nodetype_s *head, nodetype_s *tail){\
		return keytree_init_iterator_ranged_raw(offsetof(nodetype_s, link_member), ((keytree_t *) self), ((keytree_iterator_t *) iterator), head, tail);\
	}\
	\
	int				KEYTREE_ITERATOR_MOVE_(yourtree)(KEYTREE_ITERATOR_T_(yourtree) *iterator, nodetype_s *index_node){\
		return keytree_iterator_move_raw(offsetof(nodetype_s, link_member), ((keytree_iterator_t *) iterator), index_node);\
	}\
	\
	nodetype_s*		KEYTREE_ITERATOR_FORWARD_(yourtree)(KEYTREE_ITERATOR_T_(yourtree) *iterator){\
		return (nodetype_s *)keytree_iterator_forward_raw(offsetof(nodetype_s, link_member), ((keytree_iterator_t *) iterator));\
	}\
	\
	nodetype_s*		KEYTREE_ITERATOR_BACKWARD_(yourtree)(KEYTREE_ITERATOR_T_(yourtree) *iterator){\
		return (nodetype_s *)keytree_iterator_backward_raw(offsetof(nodetype_s, link_member), ((keytree_iterator_t *) iterator));\
	}\
